...
optimizer2 = tf.train.AdamOptimizer(0.1).minimize(cost)
...
with tf.Session() as sess:
    ...
    for i in range(10000):
        ...
        sess.run(optimizer2, feed_dict={X: realfire_images, Y: realfire_labels, p_keep_conv: 0.8, p_keep_hidden: 0.8})
        ...
        sess.run(optimizer, feed_dict={X: nonfire_image.data, Y: nonfire_labels.data, p_keep_conv: 0.8, p_keep_hidden: 0.8})
        sess.run(optimizer2, feed_dict={X: nonfire_image.data, Y: nonfire_labels.data, p_keep_conv: 0.8, p_keep_hidden: 0.8})
        ...
        sess.run(optimizer, feed_dict={X: nonfire_image3.data, Y: nonfire_labels3.data, p_keep_conv: 0.8, p_keep_hidden: 0.8})
        sess.run(optimizer2, feed_dict={X: nonfire_image3.data, Y: nonfire_labels3.data, p_keep_conv: 0.8, p_keep_hidden: 0.8})
        #print(accuracy.eval(feed_dict={X: test_images3, Y: test_labels3, p_keep_hidden:1.0, p_keep_conv:1.0}))
