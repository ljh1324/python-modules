...
b5 = init_bias([32], 'W5')
w6 = init_weights([16 * 16 * 32, 1024], 'W6')
b6 = init_bias([1024], 'B6')
w_out = init_weights([1024, 2], 'W_OUT')
b_out = init_bias([2], 'B_OUT')
...
realfire_images = load_image_data('./reddish/realfire_image.txt')
realfire_labels = load_result_data('./reddish/realfire_result.txt')

print(' < load nonfire data >')
nonfire_image = load_image_data('./reddish/view_image.txt')
nonfire_labels = load_result_data('./reddish/view_result.txt')

nonfire_image2 = load_image_data('./reddish/view_image2.txt')
...
composefire_labels = load_result_data('./reddish/reddish_compose_result.txt')
composefire_images = load_image_data('./reddish/reddish_compose_image.txt')

composefire_labels2 = load_result_data('./reddish/reddish_compose_result2.txt')
composefire_images2 = load_image_data('./reddish/reddish_compose_image2.txt')

composefire_labels3 = load_result_data('./reddish/reddish_compose_result3.txt')
composefire_images3 = load_image_data('./reddish/reddish_compose_image3.txt')
...
print(' < load test_set > ')
test_image_set = load_image_data('./reddish/test_image.txt')
