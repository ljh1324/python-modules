...
nonfire_image = load_image_data('./reddish/view_image1.txt')
nonfire_labels = load_result_data('./reddish/view_result1.txt')

nonfire_image2 = load_image_data('./reddish/view_image2.txt')
nonfire_labels2 = load_result_data('./reddish/view_result2.txt')

nonfire_image3 = load_image_data('./reddish/view_image3.txt')
...
composefire_images = load_image_data('./reddish/compose_image1.txt')

composefire_labels2 = load_result_data('./reddish/compose_result2.txt')
composefire_images2 = load_image_data('./reddish/compose_image2.txt')

composefire_labels3 = load_result_data('./reddish/compose_result3.txt')
composefire_images3 = load_image_data('./reddish/compose_image3.txt')
...
f = open('E:/MyPython/fire_detector_data_reddish_result.txt', 'w')
f2 = open('E:/MyPython/fire_detector_data_reddish_weight.txt', 'w')
f3 = open('E:/MyPython/fire_detector_data_reddish_biased.txt', 'w')
