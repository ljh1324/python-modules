...
# 출처: https://stackoverflow.com/questions/43284049/spectrogram-of-a-wave-file
import numpy
...
myAudio = "test3_mood_wav_duration.wav"
...
#Get duration of sound file             1 / freq = duration, duration * width = total time
...
# 고속 푸리에 변환(高速 푸리에 變換, 영어: fast Fourier transform, FFT)
# 푸리에 변환(Fourier transform, FT) 은 시간에 대한 함수 (혹은 신호) 를 함수를 구성하고 있는 주파수 성분으로 분해하는 작업이다.
# 음악에서, 악보에 코드를나타낼때, 주파수 혹은 음높이로 표현되는 것과 유사하다.
